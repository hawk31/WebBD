$(function(){
    ...
    function peticion(e){
        ...
        var parametros = {
            variable1: $('#Respuesta1').val(),
            variable2: $('#Respuesta2').val(),
            variable3: $('#Respuesta3').val(),
           /* variable3 :{
                v31:ksadad,
                v32:sdasd,
            }*/
    ...
    document.getElementById("botonCalcular").onclick = peticion;// Registrar evento al boton "Calcular" con la funcion "peticion"
});